...
// ヒープ領域（元は0x2000から拡張、最大0x2F80まで拡張可能だが、安定する値は0x2E00）
#   define configTOTAL_HEAP_SIZE (0x2E00) /* R7FA4M1AB has 32 kByte RAM total, so we only allocate 8 kByte RAM for FreeRTOS heap. */
# else
